...
package br.mayworm.external {
     ...
     */
    [Event(name='init', type='br.mayworm.SWFAddressEvent')]
    /**
     * Dispatched when any value change.
     */
    [Event(name='change', type='br.mayworm.SWFAddressEvent')]
    /**
     * Dispatched when value was changed by Flash.
     */
    [Event(name='internalChange', type='br.mayworm.SWFAddressEvent')]
    /**
     * Dispatched when value was changed by Browser.
     */
    [Event(name='externalChange', type='br.mayworm.SWFAddressEvent')]
