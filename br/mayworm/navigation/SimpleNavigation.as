...
package br.mayworm.navigation {		
	...
	public class SimpleNavigation {				
		...
		private static function SWFAddressChange(e:String):void {													
			
			var arrDiv:Array = e.split("/");			
			...
			if (e == "/") moduleAtual = pagInicial;			
			if (e == "/" && pagInicial == null) return;//nenhum modulo como default, não abrir nada		
...
//=========================================================================== FIM LOAD SWF EXTERNO		
		...
		public static function openModule(e:MaywormEvent):void {																		
			...
			if (index != null) {
				(e.params.module == pagInicial) ? SWFAddressChange("/") : SWFAddressChange("/" + e.params.module + "/");				
			}			
		}
