	...
	public class BtnSound {	
		...
		private static function evtMouseSound():Function {				
			return function(e:MouseEvent):void { 				
				...
				//var a = new SoundSkin(soundsEvents[dadosSoundsEvents[nam].name].som, 1).play();				
				var a:SoundSkin = new SoundSkin(soundsEvents[dadosSoundsEvents[nam].name].som, 1);				
				a.volume = soundsEvents[dadosSoundsEvents[nam].name].vol;
				a.play();
			};
		}
